...
// Design Name: 
// Module Name: wav_player_chat
// Description: Emits Pulse Code Modulation audio data at the configured sample rate.
//              Closed high hat audio data is pre-loaded via a .coe file into the block memory.  
//              
// Dependencies: 
// 
// Revision:
...
module wav_player_chat(
    ...
    localparam [13:0] WAV_LENGTH = 14'd10981;
    ...
    blk_mem_gen_chat u_blk_mem_chat (
