...
// Design Name: 
// Module Name: wav_player_snare
// Description: Emits Pulse Code Modulation audio data at the configured sample rate.
//              Snare drum audio data is pre-loaded via a .coe file into the block memory.  
//              
// Dependencies: 
// 
// Revision:
...
module wav_player_snare(
    ...
    localparam [13:0] WAV_LENGTH = 14'd8251;
    ...
    blk_mem_gen_snare u_blk_mem_snare (
