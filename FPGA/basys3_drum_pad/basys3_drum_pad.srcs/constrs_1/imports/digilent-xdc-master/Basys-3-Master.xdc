...
##Sch name = JC7
set_property PACKAGE_PIN L17 [get_ports {AMP_ain}]
	set_property IOSTANDARD LVCMOS33 [get_ports {AMP_ain}]
#Sch name = JC8
set_property PACKAGE_PIN M19 [get_ports {AMP_gain}]
	set_property IOSTANDARD LVCMOS33 [get_ports {AMP_gain}]
#Sch name = JC9
#set_property PACKAGE_PIN P17 [get_ports {JC[6]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {JC[6]}]
#Sch name = JC10
set_property PACKAGE_PIN R18 [get_ports {AMP_shutdown_n}]
	set_property IOSTANDARD LVCMOS33 [get_ports {AMP_shutdown_n}]
